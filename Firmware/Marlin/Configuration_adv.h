...
#define HOMING_BUMP_MM      { 8, 8, 5 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH             2  // (mm) Retracción inicial antes de mover ejes

  // --- CONFIGURACIÓN DE DESCARGA (UNLOAD) ---
  // Total botones: 40 + 560 = 600mm
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE      25  // (mm/s) Basado en tu F1500 (1500/60=25)
  #define FILAMENT_CHANGE_UNLOAD_ACCEL         25
  #define FILAMENT_CHANGE_UNLOAD_LENGTH       600  // (mm) Longitud total para Bowden

  // --- CONFIGURACIÓN DE CARGA (LOAD) ---
  // Total botones: 540 (rápido) + 60 (purga) = 600mm
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE    2  // (mm/s) F120 para inserción inicial
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH      0  // 0 para saltar directo a Fast Load
  
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   33  // (mm/s) Basado en tu F2000 (2000/60=33.3)
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL      25
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    540  // (mm) Distancia rápida por el tubo

  // --- CONFIGURACIÓN DE PURGA ---
  #define ADVANCED_PAUSE_PURGE_FEEDRATE         2  // (mm/s) F120 para purga controlada
  #define ADVANCED_PAUSE_PURGE_LENGTH          60  // (mm) Purga final para limpiar color
  #define ADVANCED_PAUSE_RESUME_PRIME           0  // No extra prime al volver

  // --- COMPORTAMIENTO DE DESCARGA ---
  // Marlin hace: Retract -> Delay -> Purge -> Unload
  // Para imitar tu "E3 F180" inicial:
  #define FILAMENT_UNLOAD_PURGE_RETRACT        13  
  #define FILAMENT_UNLOAD_PURGE_DELAY        5000  
  #define FILAMENT_UNLOAD_PURGE_LENGTH          3  // (mm) Tu empuje inicial de 3mm
  ...
  #define PARK_HEAD_ON_PAUSE                       // Activa M125
  #define CONFIGURE_FILAMENT_CHANGE                // Activa M603
#endif
