...
#define STRING_CONFIG_H_AUTHOR "(AldoRSan)" // Original author or contributor.
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 13.16 }           // (J/K) Heat block heat capacities.
    #define MPC_SENSOR_RESPONSIVENESS { 0.1248 }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
    #define MPC_AMBIENT_XFER_COEFF { 0.0887 }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1161 }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
  ...
  // Advanced options
  #define MPC_SMOOTHING_FACTOR 0.25                   // (0.0...1.0) Noisy temperature sensors may need a lower value for stabilization.
  #define MPC_MIN_AMBIENT_CHANGE 1.0f                 // (K/s) Modeled ambient temperature rate of change, when correcting model inaccuracies.
  #define MPC_STEADYSTATE 0.5f                         // (K/s) Temperature change rate for steady state logic to be enforced.

  #define MPC_TUNING_POS { X_CENTER, Y_CENTER, 1.0f } // (mm) M306 Autotuning position, ideally bed center at first layer height.
  #define MPC_TUNING_END_Z 40.0f                      // (mm) M306 Autotuning final Z position.
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 466.59 }
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 300, 3000 } // ...or, set your own edit limits
#endif
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 12000, 12000, 4000, 12000 } // ...or, set your own edit limits
#endif
...
#define HOMING_FEEDRATE_MM_M { (5000), (5000), (1000) }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS), (Y_MAX_POS), 30 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { 0, 114, 0.5 }
  #define NOZZLE_CLEAN_END_POINT   { 33, 115.5, 0.5 }
